...
public class MergeSort<T extends Comparable<T>> {
	...
	private static <T extends Comparable<T>> void mergeInPlace(int aStart, int aLength, int bStart, int bLength,
			T[] unsorted) {
		int i = aStart;
		int j = bStart;
	...
	private static <T extends Comparable<T>> void mergeWithExtraStorage(int aStart, int aLength, int bStart,
	...
	public static void main(String[] args) {
		...
		sort.sort(SPACE_TYPE.NOT_IN_PLACE, integers);
		...
		sort.sort(SPACE_TYPE.NOT_IN_PLACE, strings);
